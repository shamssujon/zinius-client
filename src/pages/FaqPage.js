    ...
    return (
        <section className="py-10">
            <div className="container max-w-4xl">
                <h2 className="mb-8 text-center text-4xl font-bold dark:text-slate-50">
                ...
                <Accordion allowToggle className="grid gap-4">
                    {faqs.map((faq) => (
                        <AccordionItem
                            key={faq.id}
                            className="overflow-hidden rounded border bg-white transition hover:shadow-md hover:shadow-slate-200">
