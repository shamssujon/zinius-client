            ...
            <div className="container">
                <div className="grid items-center gap-8 rounded-3xl border bg-white p-6 md:p-10 lg:grid-cols-2 xl:px-14 2xl:px-20">
                    <div className="">
                        ...
                        <Link className="inline-flex items-center justify-center rounded-md bg-cyan-500 px-6 md:px-8 py-4 text-center font-bold uppercase tracking-wide text-white transition hover:bg-cyan-600 ">
